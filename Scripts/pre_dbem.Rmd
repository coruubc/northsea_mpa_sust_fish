...
ggplot() + 
  geom_sf(data = fao_27) +
  geom_sf(data = grid_30_sp, size = .2, colour = "blue") + 
  geom_sf(data = grid_15_sp, size = .2, colour = "red") 
...
write.csv(grid_30_final, "grid_30.csv")
```
...
write.csv(grid_15_final, "grid_15.csv")
```
